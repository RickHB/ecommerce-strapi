...
export interface ApiCategoriaCategoria extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String & Attribute.Required;
    slug: Attribute.UID<'api::categoria.categoria', 'title'> &
      Attribute.Required;
...
export interface ApiMarcaMarca extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String & Attribute.Required;
    slug: Attribute.UID<'api::marca.marca', 'title'> & Attribute.Required;
    order: Attribute.Integer & Attribute.Required;
...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    adressShipping: Attribute.JSON & Attribute.Required;
